...
public class AMF3Encoder extends LengthFieldPrepender {
	...
	static final Log logger = LogFactory.getLog(AMF3Encoder.class);
	...
	protected Object encode(ChannelHandlerContext ctx, Channel channel,
		...
		SerializationContext serializationContext = null;// dataService.getSerializationContext(ctx.getChannel());
